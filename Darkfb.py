    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCAQQLQQJeOMwTu0jnyYmEzg?app=desktop')
                time.sleep(2)
                menu()
